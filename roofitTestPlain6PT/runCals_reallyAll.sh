...
#    echo "root -b -q runGeneralFit.C\(3,false,true,"$jobNumber",\\\"MV2c2077_tracks\\\"\)" >> submitCals/$filename
	...
	echo "root -b -q runGeneralFit.C\(0,true,false,"$jobNumber",\\\"MV2c1060\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(0,false,true,"$jobNumber",\\\"MV2c1060\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(1,true,false,"$jobNumber",\\\"MV2c1060\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(1,false,true,"$jobNumber",\\\"MV2c1060\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(2,true,false,"$jobNumber",\\\"MV2c1060\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(2,false,true,"$jobNumber",\\\"MV2c1060\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(3,true,false,"$jobNumber",\\\"MV2c1060\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(3,false,true,"$jobNumber",\\\"MV2c1060\\\"\)" >> submitCals/$filename
	
	echo "root -b -q runGeneralFit.C\(0,true,false,"$jobNumber",\\\"MV2c1070\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(0,false,true,"$jobNumber",\\\"MV2c1070\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(1,true,false,"$jobNumber",\\\"MV2c1070\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(1,false,true,"$jobNumber",\\\"MV2c1070\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(2,true,false,"$jobNumber",\\\"MV2c1070\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(2,false,true,"$jobNumber",\\\"MV2c1070\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(3,true,false,"$jobNumber",\\\"MV2c1070\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(3,false,true,"$jobNumber",\\\"MV2c1070\\\"\)" >> submitCals/$filename

	echo "root -b -q runGeneralFit.C\(0,true,false,"$jobNumber",\\\"MV2c1085\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(0,false,true,"$jobNumber",\\\"MV2c1085\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(1,true,false,"$jobNumber",\\\"MV2c1085\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(1,false,true,"$jobNumber",\\\"MV2c1085\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(2,true,false,"$jobNumber",\\\"MV2c1085\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(2,false,true,"$jobNumber",\\\"MV2c1085\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(3,true,false,"$jobNumber",\\\"MV2c1085\\\"\)" >> submitCals/$filename
	echo "root -b -q runGeneralFit.C\(3,false,true,"$jobNumber",\\\"MV2c1085\\\"\)" >> submitCals/$filename
