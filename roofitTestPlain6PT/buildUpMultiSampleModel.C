...
//	    std::cout << "HODODS pT " << pT->at(0) << " flav " << flavours->at(0) << " bweight " << bweight_MV2c10->at(0) << " weight0 " << weight0 << std::endl;
	  ...
	  if(optimisation)
	  {
	    ...
	    if(channel==0)
	    {
	      ...
	      else if(leading_pt>60e3 && leading_pt<90e3 && (imbalance>0.5)) { continue; }
	    ...
	    else if(channel==1)
	    {
	      ...
	      else if(leading_pt>90e3 && leading_pt<140e3 && (imbalance>0.7)) { continue; }
	      else if(leading_pt>140e3 && leading_pt<200e3 && (imbalance>0.72)) { continue; }
	      else if(leading_pt>200e3 && leading_pt<300e3 && (imbalance>0.84)) { continue; }
	    }
	    else if(channel==2)
	    {
	      ...
	      else if(leading_pt>200e3 && leading_pt<300e3 && (delta_phi<1.1||imbalance>1)) { continue; }
	    }
	    else if(channel==3)
	    {
	      if(leading_pt<60e3 && imbalance>0.4) { continue; }
	      else if(leading_pt>60e3 && leading_pt<90e3 && (imbalance>0.5)) { continue; }
	      else if(leading_pt>90e3 && leading_pt<140e3 && (imbalance>0.66)) { continue; }
	      else if(leading_pt>140e3 && leading_pt<200e3 && (imbalance>0.75)) { continue; }
	      else if(leading_pt>200e3 && leading_pt<300e3 && (imbalance>0.82)) { continue; }
	    }
	  }
